    ...
    <div class="conteiner">
        ...
        <div class="caixaLogin">
            ...
            <form method="post">    <!-- Sem 'Action' pois isso foi definido na verificação -->
                ...
                value="<?php if($usuario->getEmailLogin() !== null) {echo $usuario->getEmailLogin();}?>" 
                ...
                <p class="esqueceuASenha">
                    <a href="<?php echo htmlspecialchars('/facebook/recuperacao')?>" target="_self" class="esqueceuASenha"> 
                        Esqueceu a senha?
                    </a>
                </p>
            ...
            <form action="<?php echo htmlspecialchars('/facebook/cadastro');?>" method="post">
